            ...
            if(state is NewOrdersState){
              if(state.justSaved != null){
                if(state.justSaved!){
                  ...
                  builder: (subcontext){
                    return AlertDialog(title: Text("Guardado!!"), content: Text("La orden ha sido guardada"),);
                  });
                }else{
                  showDialog(context: context,
                  builder: (subcontext){
                    return AlertDialog(title: Text("Error"), content: Text("Hubo un error guardando la orden"),);
                  });
                }
              }
              widgets = (state).jobs;

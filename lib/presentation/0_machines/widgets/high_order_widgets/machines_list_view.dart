...
class MachinesListView extends StatelessWidget {
              ...
              builder: (context, state) {
                ...
                if (state is MachinesRetrieving) {
                  ...
                  children = state.machines!
                      ...
                      .toList();
                } else if (state is MachineDeletionSuccess ||
                        ...
                        child: ExpansionTile(
                          ...
                          onExpansionChanged: (value) {
                            if (state is MachinesRetrievingSuccess) {
                              ...
                              BlocProvider.of<MachineBloc>(context)
                                  .retrieveMachines(machineTypes[index].id!);
                            }
                          },
                          children: children,
                        ),
  ...
  void _addNewMachine(
    ...
    //Agregar Controller para el Preemption
    final TextEditingController preemptionController = TextEditingController();
        ...
        builder: (dialogContext) {
          return AddMachineDialog(
            ...
            addMachineHandle: () async {
              print(
                  "__________**_________Adding new machine with typeId: $machineId");
              if (controllerCapacity.text.length != 5 ||
              ...
              //else if to check if the inputs are correct, for instance, no 12:85
                ...
                print(
                    "___________________Adding new machine with typeId: $machineId");

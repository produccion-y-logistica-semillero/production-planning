...
class AddMachineDialog extends StatefulWidget {
  ...
  /// Cuando es `true` oculta los formularios de inactividades y cantidad,
  /// y ajusta los textos del diálogo al modo edición.
...
class _AddMachineDialogState extends State<AddMachineDialog> {
  ...
  void _onDeleteScheduled(MachineInactivityEntity inactivity) {
    setState(() => _scheduledInactivities.remove(inactivity));
  }
        ...
        Align(
          ...
          child: ElevatedButton.icon(
            onPressed: () {
              ...
              _showSnack(
                'Tiempo máximo de procesamiento continuo listo para guardarse con la máquina.',
              );
            },
  ...
  // ─── Section: scheduled inactivities ──────────────────────────────────────
            ...
            builder: (context, child) {
              return Theme(
                data: Theme.of(context).copyWith(
                  // WidgetState replaces the deprecated MaterialState API.
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                  ...
                  IconButton(
                    onPressed: () => printInfo(
                      ...
                      title: widget.isEditing
                          ? 'Editar maquina'
                          : 'Agregar maquina especifica',
                      content: widget.isEditing
                          ? 'Edita la maquina ${widget.machineTypeName}.'
                          : 'Agrega una maquina especifica de '
                              '${widget.machineTypeName}. Utilice porcentajes '
                              'para configurar los tiempos: 100% representa el '
                              'tiempo estándar, valores mayores a 100% indican '
                              'que la máquina es más lenta y valores menores a '
                              '100% indican que es más rápida.',
                    ),
              ...
              Text(
                widget.isEditing
                    ? 'Editar maquina de ${widget.machineTypeName}'
                    : 'Nueva maquina de ${widget.machineTypeName}',
              ...
              Row(
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () =>
                        widget.addMachineHandle(_scheduledInactivities),
                    style: const ButtonStyle(
                      padding: WidgetStatePropertyAll(EdgeInsets.all(20)),
                    ),

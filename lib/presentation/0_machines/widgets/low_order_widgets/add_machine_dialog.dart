...
class AddMachineDialog extends StatelessWidget {
  ...
  final TextEditingController
      availabilityDateTimeController; // Nuevo controlador
  final TextEditingController preemptionController;
  final void Function() addMachineHandle;

  const AddMachineDialog(this.machineTypeName,
      {super.key,
      ...
      required this.preemptionController});
  ...
  Widget build(BuildContext context) {
    return Dialog(
      child: Container(
        ...
        height: 700, // Un poco más alto para el nuevo campo
        width: 800,
        child: Column(
          children: [
            Row(
            ...
            HourField(
              text:
                  '1 hora de trabajo promedio de $machineTypeName para esta maquina equivale a: ',
            ...
            HourField(
                text: 'Tiempo de preparacion de la maquina: ',
                controller: preparationController),
            const SizedBox(
              height: 30,
            ),
            HourField(
                text: 'Tiempo de descanso necesario: ',
            ...
            Row(
              ...
              children: [
                const SizedBox(
                    width: 430,
                    child: Text(
                      'Numero de procesamientos continuos (sin descanso): ',
                      maxLines: 2,
                    )),
                SizedBox(
                  width: 180,
            ...
            //Campo de para decir si soporta Preemption[si/no](No aplicar lógica de preemption)
            const SizedBox(
              height: 30,
            ),
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                const Text("Soporta Preemption: "),
                const SizedBox(width: 12),
                SizedBox(
                  width: 220,
                  child: DropdownButtonFormField<String>(
                    value: preemptionController.text.isNotEmpty
                        ? preemptionController.text
                        : null,
                    items: const [
                    ...
                    onChanged: (value) {
                      preemptionController.text = value ?? '';
                    },
                    decoration: const InputDecoration(
                      border: OutlineInputBorder(),
                      isDense: true,

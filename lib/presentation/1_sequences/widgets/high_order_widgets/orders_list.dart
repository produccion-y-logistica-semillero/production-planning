      ...
      builder: (context, state) {
        if (state.selectedProcess != null && state.process != null) {
          ...
          WidgetsBinding.instance.addPostFrameCallback((_) {
            nodeEditorKey.currentState
                ?.loadNodesAndConnections(machines, connections);
          });
        }
        ...
        Widget dropdown = PopupMenuButton<int>(
          ...
          onSelected: (int selectedId) async {
            ...
            final process =
                BlocProvider.of<SeeProcessBloc>(context).state.process;
            if (process != null && process.tasks != null) {
              ...
              final connections = (process.dependencies ?? [])
                  .map(
                      (dep) => Connection(dep.predecessor_id, dep.successor_id))
                  .toList();
                      ...
                      onTap: () async {
                        final confirm = await showDialog<bool>(
                          ...
                          builder: (ctx) => AlertDialog(
                            ...
                            content: Text(
                                '¿Estás seguro de eliminar "${seq.name}"?'),
                            actions: [
                              TextButton(
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  ...
                  fontStyle:
                      state.selectedProcess != null ? null : FontStyle.italic,
                ),
              ),
              const SizedBox(width: 6),
                ...
                Align(
                  ...
                  child: Container(
                    constraints: const BoxConstraints(
                        maxWidth: 300), // ajusta si quieres más
                    padding:

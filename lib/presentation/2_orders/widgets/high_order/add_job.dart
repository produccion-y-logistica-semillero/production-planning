...
class AddJobWidget extends StatefulWidget {
  ...
  final GlobalKey<AddJobState> stateKey = GlobalKey<AddJobState>();
...
class AddJobState extends State<AddJobWidget> {
  ...
  final Map<int, int> _preemptionMatrix = {}; // Map<machineId, canPreempt (0 o 1)>
            ...
            return AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                    'Matriz de Pre-emption (Interrupciones)',
                    style: TextStyle(
                  ...
                  ..._buildPreemptionMatrixForTask(machineTypeId),
                ],
              ),
              actions: [
                TextButton(

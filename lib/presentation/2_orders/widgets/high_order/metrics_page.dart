...
class MetricsPage extends StatelessWidget {
  ...
  const MetricsPage({super.key, required this.metrics});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildMetricRow(
                'Tardanza maxima',
                _formatDuration(metrics.maxDelay),
              ),
              _buildMetricRow(
                'Flujo promedio',
              ...
              _buildMetricRow(
                'Trabajos retrasados',
                metrics.delayedJobs.toString(),
              ),
              _buildMetricRow(
                'Porcentaje trabajos retrasados',
                '${metrics.percentageDelayedJobs.toStringAsFixed(2)}%',
              ),
              _buildMetricRow('Makespan', _formatDuration(metrics.makespan)),
              _buildMetricRow(
                'Flujo Total',
                _formatDuration(metrics.totalFlowTime),
              ),
              const SizedBox(height: 20),
              Align(

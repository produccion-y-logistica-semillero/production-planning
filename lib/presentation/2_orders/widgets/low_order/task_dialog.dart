...
class TaskDialog extends StatelessWidget {
  ...
  Widget _buildOrderInfo(OrderEntity order) {
    ...
    final taskInfo =
        job.sequence!.tasks!.firstWhere((t) => t.id == task.taskId);
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          _buildInfoRow("Secuencia", task.displayName),
          _buildInfoRow("ID tarea", task.taskId.toString()),
          _buildInfoRow("Tiempo procesamiento",
              '${taskInfo.processingUnits.inHours.toString().padLeft(2, '0')}:${(taskInfo.processingUnits.inMinutes - (taskInfo.processingUnits.inHours * 60)).toString().padLeft(2, '0')}'),
          /* _buildInfoRow(
            "Número ejecución",
